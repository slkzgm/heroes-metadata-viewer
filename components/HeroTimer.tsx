...
export default function HeroTimer({ timestamp, cooldownHours = 12, timerType = "training" }: HeroTimerProps) {
    ...
    return (
        <div className="mt-2">
            <div className="flex justify-between text-xs mb-1">
                <span>{timerType === "training" ? "Next Training" : "Unstakable In"}</span>
          ...
          <span className={`inline-block px-2 py-1 ${timerType === "training" ? 'bg-green-600' : 'bg-blue-600'} rounded-md text-xs animate-pulse`}>
